...
if __name__ == "__main__":
    ...
    log_path =  path + '/tl_log/'
    outdir_2 = path + '/tl_models/{}k_tl_SAC_model'


    # model = SAC('MlpPolicy', env, learning_starts=1, verbose=2, learning_rate=0.0001, policy_kwargs=policy_kwargs, batch_size=200, tensorboard_log=log_path)
