...
import numpy as np
from openloop_walker.envs import rex_gym_env
from openloop_walker.model import rex_constants
...
class RexWalkEnv(rex_gym_env.RexGymEnv):
  ...
  """
    ...
    """
        ...
        upper_bound[18:] = math.pi / self._time_step
        return upper_bound
